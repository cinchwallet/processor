...
/**
 * A <code>OneIncLogger</code> is used to log messages for a specific system or
 * application component. It uses the log4j.xml to define different appenders.
 * Corresponding to each appender, Logger object has been created by calling the
 * getLogger factory methods as shown below:
 * <p>
 ...
 * the log4j.xml. Create a new instance of the Logger for that appender as
 * follow:
 * <p>
 * Logger systemLog = Logger.getLogger(TXN_LOG);
 * <p>
 * Now, you are ready to use this newly created logger, using the following
 * code:
 * <p>
...
public class CWLogger extends QBeanSupport implements ReConfigurable {
	...
	protected void initService() throws Exception {
		...
		if (log4jxmlFile.exists()) {
			...
			cwIssuerLog = Logger.getLogger(CWISSUER_LOGGER);
		} else {
